    ...
    <>
      ...
      <Question id="but-why" title="Why would I use this?">
        ...
        <p className="my-5 font-mono">
          ...
          improve performance by moving computation <em>even closer</em> to the
          data. This is especially true for functions that are called often and
        ...
        <p className="my-5 font-mono">
          ...
          guarantees that would make this technique suitable for general purpose
          use.
        </p>
      </Question>
      ...
      <Question id="just-react" title="Is it exclusive to React?">
        <p className="my-5 font-mono">
          The technique is not exclusive to React. The runtime it implements on
          top of PLV8 is very minimal.
        </p>
      ...
      <Question id="0day" title={"What's the security model?"}>
        <p className="my-5 font-mono">
          While not tested or audited, the security model is similar to regular
          Serverless Functions in that the code is executed in an isolated
          environment.
        </p>

        <p className="my-5 font-mono">
          These functions, however, are never exposed directly as API Routes or
          HTTP endpoints. Instead, in the examples above, they are themselves
          invoked from React Server Components like normal SQL.
        </p>
      </Question>
    </>
  );
